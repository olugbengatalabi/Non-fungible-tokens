from brownie import network, accounts, config, VRFCoordinatorMock, MockV3Aggregator, LinkToken, Contract, interface
...
def fund_with_link(contract_address, account=None, link_token=None, amount=100000000000000000):
  # in the amount you can just use web3.toWei
...
def get_breed(breed_number):
  return BREEED_MAPPING[breed_number]
